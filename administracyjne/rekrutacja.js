...
module.exports.run = async(bot, message, args, msg) => {
  const incidentchannel = message.guild.channels.find('id', '531565730731130900');//mod-log channel name. change for you
  if (!incidentchannel) return message.channel.send("Nie mogę znaleźć kanału. ``ID: 531565730731130900``");
    cmd = message.content;
...
module.exports.help = {
  name: "wesdxrcfctvgyazwsexdrcftvgwsexdrcftvgybws3edxrcftvgbyhwsedrxcfvtgbyhed4rftvgybhwsexdrcfvtgbws3ed4rcftvgby"
};
