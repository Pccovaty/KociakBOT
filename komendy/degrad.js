...
module.exports.run = async(bot, message, args) => { //exportujesz komendę
    if (message.author.id !== "340557425511759892") return message.channel.send(":lock: | Dostęp zablokowany, Tą komendę może używać tylko osoba z rolą Zarząd lub Właściciel.");
     if (message.author.id !== "333529845025865728") return message.channel.send(":lock: | Dostęp zablokowany, Tą komendę może używać tylko osoba z rolą Zarząd lub Właściciel.");
